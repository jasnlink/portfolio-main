	...
	<>
			...
			<Card sx={{ backgroundColor: '#141414', border: 'solid #c3c3c33d 1px', color: '#eeeeef', p: '10% 6%' }} square>
				<Grid container spacing={2} direction="row" justifyContent="center" alignItems="center">
					...
					<Grid item xs={12}>
						{desktopMode && (
							<img style={{ position: 'relative', width: '80%' }} src="https://msmtech.ca/wp-content/uploads/2022/04/1.jpg" alt="PrimeElo" />
						)}
						{!desktopMode && (
							<img style={{ position: 'relative', width: '114%', marginLeft: '-7%' }} src="https://msmtech.ca/wp-content/uploads/2022/04/1.jpg" alt="PrimeElo" />
						)}
					</Grid>
					<Grid item xs={12}>
					...
					<Grid item xs={12}>
						{desktopMode && (
							<img style={{ position: 'relative', width: '80%' }} src="https://msmtech.ca/wp-content/uploads/2022/04/2.jpg" alt="Features" />
						)}
						{!desktopMode && (
							<img style={{ position: 'relative', width: '114%', marginLeft: '-7%' }} src="https://msmtech.ca/wp-content/uploads/2022/04/2.jpg" alt="Features" />
						)}
					</Grid>
					<Grid item xs={12}>
						<Typography variant="h3" sx={{ fontSize: '20px', mt: '20px' }}>
